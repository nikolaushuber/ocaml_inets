...
speedup: results build 
	${HYPERFINE}/fib38.json '${FIB} ${FIB_ARG} {N}' 
	${HYPERFINE}/qsort_10000.json '${QSORT} ${SORT_ARG} {N} ${SORT_SEED}'
	${HYPERFINE}/msort_10000.json '${MSORT} ${SORT_ARG} {N} ${SORT_SEED}'
...
fib_ex: results build 
	...
	${PYTHON} scripts/plot_fib_ex.py --cpus=${NUM_CPUS} -o ./results/fib_ex.png
